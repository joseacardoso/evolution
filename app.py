                ...
                if escolha != "Nenhum":
                    ...
                    if info.get("per_user"):
                        if escolha in WEB_ONLY_MODULES:
                            ...
                            qtd_desk = st.number_input(label, min_value=0, step=1, format="%d")
...
st.title("Simulador Evolution")
product = st.radio("Produto", ["PHC Evolution", "Primavera Evolution"], horizontal=True)

if product == "PHC Evolution":
    render_phc()
else:
    render_primavera()
